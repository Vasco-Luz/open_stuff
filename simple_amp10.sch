...
plot deriv(v(VOUT))
tran 10ns 20u
plot (v(VOUT)-1.8318) (v(VIN)-0.250)
...
C {devices/vsource.sym} 80 -400 0 0 {name=V2 value=0.250}
...
C {devices/lab_pin.sym} 340 -60 0 0 {name=p3 sig_type=std_logic lab=VIN}
...
device=resistor
m=1}
C {devices/lab_pin.sym} 370 -390 0 0 {name=p8 sig_type=std_logic lab=VB}
C {devices/vsource.sym} -230 -390 0 0 {name=V5 value=1
}
C {devices/gnd.sym} -230 -340 0 0 {name=l1 lab=GND}
C {devices/lab_pin.sym} -230 -460 0 0 {name=p9 sig_type=std_logic lab=VB1}
C {devices/lab_pin.sym} 340 -190 0 0 {name=p10 sig_type=std_logic lab=VB1}
