...
S {}
E {}
T {high gain but its not good.
The gain equation is very complex and makes something that is not good as an amplifier} 530 -30 0 0 0.4 0.4 {}
N 100 -350 100 -330 {
lab=GND}
N 100 -450 100 -410 {
lab=VDD}
...
C {devices/vsource.sym} 180 -380 0 0 {name=V2 value=0.990}
...
C {devices/lab_pin.sym} 720 -450 2 0 {name=p5 sig_type=std_logic lab=VOUT}
C {devices/vsource.sym} 50 430 0 0 {name=V3 value="ac 1.0 sin (0 1m 1k)"}
C {devices/gnd.sym} 180 -310 0 0 {name=l5 lab=GND}
C {devices/res.sym} 680 -420 0 0 {name=R2
value=10G
footprint=1206
device=resistor
m=1}
C {devices/gnd.sym} 680 -370 0 0 {name=l6 lab=GND}
...
C {devices/lab_pin.sym} 610 -330 0 0 {name=p11 sig_type=std_logic lab=VA
}
...
C {devices/vsource.sym} -220 -400 0 0 {name=V6 value=2}
