...
E {}
T {A source follower.
Its a more corrected source follower. because of the diode connected loads
Gain can never be greater than 1
has a big bandwith
} 530 -30 0 0 0.4 0.4 {}
N 100 -350 100 -330 {
lab=GND}
...
C {devices/lab_pin.sym} 660 -330 2 0 {name=p5 sig_type=std_logic lab=VOUT}
C {devices/vsource.sym} 50 430 0 0 {name=V3 value="ac 1.0 sin (0 100u 1k)"}
C {devices/gnd.sym} 180 -310 0 0 {name=l5 lab=GND}
C {devices/res.sym} 620 -300 0 0 {name=R2
value=10G
footprint=1206
device=resistor
m=1}
C {devices/gnd.sym} 620 -250 0 0 {name=l6 lab=GND}
...
device=resistor
m=1}
C {devices/capa.sym} 400 450 3 0 {name=C2
m=1
value=1000m
footprint=1206
device="ceramic capacitor"}
C {devices/res.sym} 470 480 0 0 {name=R5
value=10G
footprint=1206
device=resistor
m=1}
C {devices/gnd.sym} 470 530 0 0 {name=l9 lab=GND}
C {devices/lab_pin.sym} 510 450 2 0 {name=p8 sig_type=std_logic lab=VOUTT}
...
C {devices/ammeter.sym} 310 170 0 0 {name=Vmeas1}
C {devices/lab_pin.sym} 310 110 0 0 {name=p4 sig_type=std_logic lab=VDD}
C {symbols/nfet_06v0.sym} 290 550 0 0 {name=M1
L=2u
W=10u
nf=1
m=1
...
C {devices/gnd.sym} 330 550 0 0 {name=l1 lab=GND}
C {symbols/pfet_06v0.sym} 290 270 0 0 {name=M4
L=0.5u
W=100u
nf=1
m=1
...
C {devices/lab_pin.sym} 360 270 0 1 {name=p16 sig_type=std_logic lab=VDD}
C {devices/gnd.sym} 310 610 0 0 {name=l13 lab=GND}
C {symbols/nfet_06v0.sym} 290 380 0 0 {name=M6
L=0.7u
W=100u
nf=1
m=1
...
C {devices/gnd.sym} 350 380 0 0 {name=l14 lab=GND}
