...
S {}
E {}
T {M3 i dont know if it is in saturation
Another source follower but with saturated MOS as Loads
} 530 -30 0 0 0.4 0.4 {}
N 100 -350 100 -330 {
lab=GND}
N 100 -450 100 -410 {
...
C {devices/vsource.sym} 180 -380 0 0 {name=V2 value=4.5}
...
C {devices/lab_pin.sym} 700 -310 2 0 {name=p5 sig_type=std_logic lab=VOUT}
...
device=resistor
m=1}
C {devices/gnd.sym} 660 -230 0 0 {name=l6 lab=GND}
...
device=resistor
m=1}
C {devices/capa.sym} 460 470 3 0 {name=C2
m=1
value=10m
footprint=1206
device="ceramic capacitor"}
C {devices/res.sym} 530 500 0 0 {name=R5
value=10G
footprint=1206
device=resistor
m=1}
C {devices/gnd.sym} 530 550 0 0 {name=l9 lab=GND}
C {devices/lab_pin.sym} 570 470 2 0 {name=p8 sig_type=std_logic lab=VOUTT}
...
C {symbols/pfet_06v0.sym} 350 270 0 0 {name=M7
L=2u
W=10u
nf=1
m=1
