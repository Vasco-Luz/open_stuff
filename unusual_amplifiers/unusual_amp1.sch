...
bascicly in this configuration the relation between RD and RF control the initial VOUT voltage. 
As Id increases, Vout has to decrease so (VDD-VOUT)/RD can be equal to ID + VOUT/RF + VOUT/RL.
In this the 6V MOS were used} 810 -210 0 0 0.4 0.4 {}
N 430 -400 430 -370 {
lab=#net1}
N 100 -350 100 -330 {
lab=GND}
...
C {devices/gnd.sym} 450 -140 0 0 {name=l2 lab=GND}
C {devices/lab_pin.sym} 360 -220 0 0 {name=p4 sig_type=std_logic lab=VIN
}
...
C {devices/gnd.sym} 490 270 0 0 {name=l8 lab=GND}
