...
E {}
T {An cascode stage.
Same thing but with an PMOS input. In this case the gain is always smaller because of the PMOS
But it can be observed that the gain is more linear and has a bigger bandwith.
VB are dimensionated to make sure the NMOS are kept in saturation.
The gain can be increased by reducing W2 and W3
} 530 -30 0 0 0.4 0.4 {}
N 100 -350 100 -330 {
lab=GND}
N 100 -450 100 -410 {
...
C {devices/vsource.sym} 180 -380 0 0 {name=V2 value=5.110}
...
device=resistor
m=1}
C {devices/capa.sym} 610 420 3 0 {name=C2
m=1
value=100m
footprint=1206
device="ceramic capacitor"}
C {devices/res.sym} 680 450 0 0 {name=R5
value=10G
footprint=1206
device=resistor
m=1}
C {devices/gnd.sym} 680 500 0 0 {name=l9 lab=GND}
C {devices/lab_pin.sym} 720 420 2 0 {name=p8 sig_type=std_logic lab=VOUTT}
C {devices/lab_pin.sym} 60 380 1 0 {name=p9 sig_type=std_logic lab=VINT
}
C {devices/vsource.sym} -60 -350 0 0 {name=V4 value=1.8
}
...
C {devices/vsource.sym} -150 -350 0 0 {name=V5 value=1
}
...
C {devices/ammeter.sym} 430 310 0 0 {name=Vmeas1}
C {devices/lab_pin.sym} 430 250 0 0 {name=p15 sig_type=std_logic lab=VDD}
C {symbols/pfet_06v0.sym} 410 380 0 0 {name=M4
L=0.5u
W=100u
nf=1
m=1
...
C {symbols/nfet_06v0.sym} 410 460 0 0 {name=M5
L=2u
W=20u
nf=1
m=1
...
C {symbols/nfet_06v0.sym} 410 550 0 0 {name=M6
L=2u
W=20u
nf=1
m=1
...
C {devices/gnd.sym} 430 590 0 0 {name=l11 lab=GND}
C {devices/gnd.sym} 480 550 0 0 {name=l12 lab=GND}
C {devices/gnd.sym} 470 460 0 0 {name=l13 lab=GND}
C {devices/lab_pin.sym} 360 460 0 0 {name=p17 sig_type=std_logic lab=VB1}
C {devices/lab_pin.sym} 470 380 2 0 {name=p18 sig_type=std_logic lab=VDD}
C {devices/lab_pin.sym} 370 550 0 0 {name=p19 sig_type=std_logic lab=VB2
value=2}
