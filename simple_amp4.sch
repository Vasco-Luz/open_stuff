...
plot v(VOUT) deriv(v(VOUT)) v(VIN) (v(VIN)-v(VS)) (v(VOUT)-v(VS))
plot v(VOUT) deriv(v(VOUT)) 
plot i(Vmeas) 
plot deriv(v(VOUT))
tran 10ns 20u
plot (v(VOUT)-1.37287) (v(VIN)-1.3)
...
C {devices/vsource.sym} 80 -400 0 0 {name=V2 value=1.3}
...
C {devices/lab_pin.sym} 430 -140 0 0 {name=p4 sig_type=std_logic lab=VS}
