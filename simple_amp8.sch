...
C {devices/vsource.sym} 80 -400 0 0 {name=V2 value=1.94}
...
C {devices/lab_pin.sym} 330 -390 0 0 {name=p3 sig_type=std_logic lab=VIN}
...
C {devices/lab_pin.sym} 240 -190 0 0 {name=p8 sig_type=std_logic lab=VB}
