...
plot deriv(v(VOUT))
tran 1u 5m
plot (v(VOUT)-1.89567) (v(VIN)-1.075)
...
C {devices/vsource.sym} 80 -400 0 0 {name=V2 value=1.075}
...
C {devices/vsource.sym} 80 -300 0 0 {name=V3 value="ac 1.0 sin (0 10u 1k)"}
C {devices/lab_pin.sym} 80 -470 0 0 {name=p6 sig_type=std_logic lab=VIN}
C {devices/lab_pin.sym} 390 -10 0 0 {name=p3 sig_type=std_logic lab=VIN}
...
C {devices/vsource.sym} -250 -390 0 0 {name=V5 value=1.9
}
C {devices/gnd.sym} -250 -340 0 0 {name=l7 lab=GND}
C {devices/lab_pin.sym} -250 -460 0 0 {name=p8 sig_type=std_logic lab=VB1}
C {devices/lab_pin.sym} 360 -350 0 0 {name=p9 sig_type=std_logic lab=VB1}
