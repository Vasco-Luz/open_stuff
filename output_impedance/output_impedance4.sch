...
C {devices/lab_pin.sym} 500 -460 0 0 {name=p2 sig_type=std_logic lab=VDD}
...
C {devices/vsource.sym} 390 -300 0 0 {name=V4 value=2.7}
...
C {devices/vsource.sym} 420 -120 0 0 {name=V5 value=1.2}
