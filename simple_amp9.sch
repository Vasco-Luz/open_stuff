...
C {devices/vsource.sym} 80 -400 0 0 {name=V2 value=0.8}
...
C {symbols/nwell.sym} 300 -460 0 0 {name=R2
W=5e-6
L=5e-6
model=nwell
spiceprefix=X
...
C {devices/lab_pin.sym} 370 -190 0 0 {name=p3 sig_type=std_logic lab=VIN}
...
C {symbols/nwell.sym} 300 -350 0 0 {name=R1
W=5e-6
L=5e-6
model=nwell
spiceprefix=X
...
C {devices/gnd.sym} 230 -400 0 0 {name=l1 lab=GND}
C {devices/lab_pin.sym} 350 -390 1 0 {name=p8 sig_type=std_logic lab=VG}
